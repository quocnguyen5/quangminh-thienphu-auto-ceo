    ...
    try:
        ...
        if all_match:
            ...
            if current_chrome_version != '':
                ...
                version_match = [i for i in all_match if re.search(
                    '^%s' % current_chrome_version, i)]
            ...
            chromedriver_path = os.path.normpath(os.path.join(
                app_path, webdriver_folder_name, 'chromedriver.exe'))
